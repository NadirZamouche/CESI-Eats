...
// sections
import { ProductListHead, ProductListToolbar, ProductAdd, ProductEdit } from '../sections/@dashboard/component';
...
export default function ProductPage() {
  ...
  const handleDelete = () => {
    if (editId) {
      axios
        .delete(`${process.env.REACT_APP_IP_ADDRESS}/components/${editId}`, {
          headers: {
            accessToken: localStorage.getItem("accessToken"),
            apikey: process.env.REACT_APP_API_KEY,
          },
  ...
  return (
    <>
      ...
      <ProductEdit open={openEdit} handleClose={handleCloseEdit} id={editId} handleMessage={handleMessage} handleMessageShow={handleMessageShow} />
